...
token <- '../data/gdc-user-token.2023-01-23T07_46_08.804Z.txt'
...
if(length(c_select) > 0){
    ...
    fwrite(temp_final1, paste0('../data/',c_select,'_manifest_final.txt'), sep='\t', row.names=FALSE, quote=FALSE)
    ...
    fwrite(temp_final2, paste0('../data/',c_select,'_manifest_final_allCancer.txt'), sep='\t', row.names=FALSE, quote=FALSE)
